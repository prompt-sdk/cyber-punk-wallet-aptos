...
type FormNameFieldProps<T extends FieldValues> = {
  label: string;
...
export default function FormNameField<T extends FieldValues>({
  label,
  name,
  form,
  error,
    ...
    <div className="lg-gap-3 flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-1">
        ...
        {error ? (
          ...
          <p className="text-[8px] text-green-500 sm:text-[10px]">Account ID available</p>
        ) : (
